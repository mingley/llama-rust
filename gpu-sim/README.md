...
`graph_memcpy_set_params_1d` / `graph_memcpy_set_params_2d` / `graph_memset_set_params` /
...
`graph_exec_memcpy_set_params_1d` / `graph_exec_memcpy_set_params_2d` / `graph_exec_memset_set_params` /
