...
| `pointer_get_attribute` wraps type / mapped / pool / range / ordinal / start / buffer id; SyncMemops is settable | `cuPointerGetAttribute` / `SetAttribute` |
...
BufferId are query-only). Set is capture-refused;
Get is a query.
