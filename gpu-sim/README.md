...
| `cudaGraphAddKernelNode` / memcpy / `AddMemcpyNode1D` / `graph_add_memcpy_2d` / memset / host / empty / event / child / mem alloc/free / cooperative kernel / dependencies (`graph_add_*`) | not timed (host-side topology) |
