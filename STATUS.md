# Stopped 2026-08-27 — NVFP4 2-D weights
...
- GGUF v3: F32, F16, BF16, Q4_0, Q4_1, Q5_0, Q5_1, Q8_0, Q2_K, Q3_K, Q4_K, Q5_K, Q6_K, Q8_K, IQ1_M, IQ1_S, IQ2_XXS, IQ2_XS, IQ2_S, IQ3_XXS, IQ3_S, IQ4_NL, IQ4_XS, MXFP4, NVFP4. Kernels read on-disk bytes (no private f32-scale copy).
...
- Q4_K_M shape that common OSS files actually have:
  - quantized `token_embd.weight` (Q2_K / Q3_K / Q4_1 / Q4_K / Q5_0 / Q5_1 / Q5_K / Q6_K / IQ1_M / IQ1_S / IQ2_XXS / IQ2_XS / IQ2_S / IQ3_XXS / IQ3_S / IQ4_NL / IQ4_XS / MXFP4 / NVFP4 / F32) or F16 / BF16
...
Nothing. This slice is STATUS item 2 (NVFP4). Metal-in-crate was skipped: this Linux VM cannot compile or run Metal.
...
2. **Dtypes / arches still rejected.** Gemma, MoE, vision, Qwen3, Llama4. 1-D F16 norms/bias still rejected. Tied `output.weight` (reuse `token_embd`) untested. Common OSS IQ* 2-D, BF16 2-D, Q2_K 2-D, Q3_K 2-D, Q4_1 2-D, Q5_0 2-D, Q5_1 2-D, MXFP4 2-D, and NVFP4 2-D are loaded (IQ1_M / IQ1_S / IQ2_XXS / IQ2_XS / IQ2_S / IQ3_XXS / IQ3_S / IQ4_NL / IQ4_XS / BF16 / Q2_K / Q3_K / Q4_1 / Q5_0 / Q5_1 / MXFP4 / NVFP4). Next remaining rejected type id is Q1_0 = 41.
...
Next code change should be item 1 (Metal-in-crate) on a machine that can compile Metal, or remaining item-2 work (Q1_0, Gemma / MoE / vision / Qwen3 / Llama4, 1-D F16 norms/bias, tied `output.weight`). Do not add crates.io runtime deps or `unsafe`. Do not start Metal-in-crate on Linux.
