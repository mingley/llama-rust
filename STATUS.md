# Stopped 2026-08-28 — ggml-removed type 36
...
Nothing. This slice is STATUS item 2 (ggml-removed type 36). Metal-in-crate was skipped: this Linux VM cannot compile or run Metal.
...
Next code change should be item 1 (Metal-in-crate) on a machine that can compile Metal, or remaining item-2 work (Gemma / MoE / vision / Qwen3 / Llama4, 1-D F16 norms/bias, tied `output.weight`). Do not add crates.io runtime deps or `unsafe`. Do not start Metal-in-crate on Linux. Do not invent a `block_iq4_nl_4_4` dequant.
