...
infer-bench schedule tests/traces/tiny-qwen3moe-2layer.jsonl --capacity 2 --seq-streams --compute-slots 4 --cluster 2 --func-cluster-spread
infer-bench schedule tests/traces/tiny-qwen3moe-2layer.jsonl --capacity 2 --seq-streams --compute-slots 4 --cluster 2 --cluster-must-set
infer-bench schedule tests/traces/tiny-qwen3moe-2layer.jsonl --capacity 2 --seq-streams --compute-slots 4 --cluster 2 --required-cluster 2
...
infer-bench schedule tests/traces/tiny-qwen3moe-2layer.jsonl --capacity 2 --decode-priority --device-sync-policy blocking
