...
./target/release/gguf_gemv engine tiny-llama.gguf -p a -p b --kv-page 2
./target/release/gguf_gemv engine tiny-qwen3moe.gguf -p a -p b --kv-page 2 --expert-slots 0
./target/release/gguf_gemv engine tiny-qwen3moe.gguf -p a -p b --kv-page 2 --expert-sim
