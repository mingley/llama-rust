    ...
    I: IntoIterator<Item = String>,
{
    ...
    if stream_attach || managed_host || prefetch_host || no_read_mostly || no_preferred {
        managed = true;
    }
