//! Pure-safe GGUF-native Llama decode + F32/F16/Q4_0/Q8_0/Q4_K/Q5_K/Q6_K/Q8_K/IQ4_XS. No llama.cpp, no C GGML.
...
pub use decode::{
    generate, generate_ctx, greedy_generate, greedy_generate_ctx, tiny_f16_gguf, tiny_iq4xs_gguf,
...
pub use quant::{
    dequant_f16_row, dequant_f32_row, dequant_iq4_xs_row, dequant_q4_k_row, dequant_q5_k_row,
    dequant_q6_k_row, f16_row_bytes, f32_row_bytes, gemm_f16, gemm_f32, gemm_iq4_xs_f32,
    gemm_q4_k_f32, gemm_q5_k_f32, gemm_q6_k_f32, gemv_f16, gemv_f32, gemv_iq4_xs_f32, gemv_q4_0,
    gemv_q4_k, gemv_q4_k_f32, gemv_q5_k_f32, gemv_q6_k_f32, gemv_q8_0, iq4_xs_row_bytes, pack_f16,
    pack_f32, pack_iq4_xs_block, pack_q4_0_block, pack_q4_0_from_i4, pack_q4_k_block,
