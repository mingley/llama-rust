//! Pure-safe GGUF-native Llama decode + F32/F16/Q4_0/Q8_0/Q4_K/Q5_K/Q6_K/Q8_K/IQ2_XXS/IQ2_S/IQ3_XXS/IQ3_S/IQ4_NL/IQ4_XS. No llama.cpp, no C GGML.
...
pub use decode::{
    ...
    tiny_llama_gguf, tiny_mistral_gguf, tiny_phi3_gguf, tiny_q4k_embd_gguf, tiny_q5k_gguf,
...
pub use quant::{
    ...
    gemv_iq4_xs_f32, gemv_q4_0, gemv_q4_k, gemv_q4_k_f32, gemv_q5_k_f32, gemv_q6_k_f32, gemv_q8_0,
    iq2_s_row_bytes, iq2_xxs_row_bytes, iq3_s_row_bytes, iq3_xxs_row_bytes, iq4_nl_row_bytes,
    iq4_xs_row_bytes, pack_f16, pack_f32, pack_iq2_s_block, pack_iq2_xxs_block, pack_iq3_s_block,
    ...
    QuantError, F16_SIZE, F32_SIZE, IQ2_S_BLOCK, IQ2_XXS_BLOCK, IQ3_S_BLOCK, IQ3_XXS_BLOCK,
