...
use crate::quant::{
    ...
    gemv_q1_0_f32, gemv_q2_0_f32, gemv_q2_k_f32, gemv_q3_k_f32, gemv_q4_1_f32, gemv_q4_k_f32,
    gemv_q5_0_f32, gemv_q5_1_f32, gemv_q5_k_f32, gemv_q6_k_f32, gemv_q8_1_f32, gemv_tq1_0_f32,
    ...
    pack_q5_0_block, pack_q5_1_block, pack_q5_k_block, pack_q6_k_block, pack_q8_1_block,
    pack_tq1_0_block, q1_0_row_bytes, q2_0_row_bytes, q2_k_row_bytes, q3_k_row_bytes,
    q4_1_row_bytes, q4_k_row_bytes, q5_0_row_bytes, q5_1_row_bytes, q5_k_row_bytes, q6_k_row_bytes,
    q8_1_row_bytes, tq1_0_row_bytes, QuantError, QK1_0, QK2_0, QK4_1, QK4_NL, QK5_0, QK5_1, QK8_1,
...
struct TinySpec {
    ...
    /// BF16 / MXFP4 / NVFP4 / Q1_0 / Q2_0 / Q8_1 / TQ1_0 are used by [`tiny_q2k_gguf`] / [`tiny_q3k_gguf`] / [`tiny_q41_gguf`] /
    ...
    /// [`tiny_q20_gguf`] / [`tiny_q81_gguf`] / [`tiny_tq10_gguf`].
...
mod tests {
    ...
    fn decode_load_unsupported_ggml_type_error_includes_type_id() {
        // ggml TQ2_0 is 35; TQ1_0 (34) is now loaded. Remaining after TQ1_0.
        const TQ2_0: i32 = 35;
        ...
        assert!(
            err.contains(&TQ2_0.to_string()),
            "error should include type id {TQ2_0}: {err}"
        );
    }
