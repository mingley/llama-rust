...
use crate::quant::{
    ...
    iq3_s_row_bytes, iq3_xxs_row_bytes, iq4_nl_row_bytes, iq4_xs_row_bytes, pack_f16, pack_f32,
    pack_iq2_s_block, pack_iq3_s_block, pack_iq3_xxs_block, pack_iq4_nl_block, pack_iq4_xs_block,
    pack_q4_k_block, pack_q5_k_block, pack_q6_k_block, q4_k_row_bytes, q5_k_row_bytes,
...
struct TinySpec {
    ...
    /// Q4_K / Q6_K / F32 mix used by [`tiny_llama_gguf`]. Q5_K / IQ2_S / IQ3_XXS /
    /// IQ3_S / IQ4_NL / IQ4_XS are used by [`tiny_q5k_gguf`] / [`tiny_iq2s_gguf`] /
...
mod tests {
    ...
    fn decode_load_unsupported_ggml_type_error_includes_type_id() {
        // ggml IQ2_XXS is 16; remaining IQ* stay rejected after IQ2_S shipped.
