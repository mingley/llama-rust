...
use crate::quant::{
    ...
    gemv_q3_k_f32, gemv_q4_1_f32, gemv_q4_k_f32, gemv_q5_k_f32, gemv_q6_k_f32, iq1_m_row_bytes,
    iq1_s_row_bytes, iq2_s_row_bytes, iq2_xs_row_bytes, iq2_xxs_row_bytes, iq3_s_row_bytes,
    iq3_xxs_row_bytes, iq4_nl_row_bytes, iq4_xs_row_bytes, pack_bf16, pack_f16, pack_f32,
    pack_iq1_m_block, pack_iq1_s_block, pack_iq2_s_block, pack_iq2_xs_block, pack_iq2_xxs_block,
    pack_iq3_s_block, pack_iq3_xxs_block, pack_iq4_nl_block, pack_iq4_xs_block, pack_q2_k_block,
    pack_q3_k_block, pack_q4_1_block, pack_q4_k_block, pack_q5_k_block, pack_q6_k_block,
    q2_k_row_bytes, q3_k_row_bytes, q4_1_row_bytes, q4_k_row_bytes, q5_k_row_bytes, q6_k_row_bytes,
    QuantError, QK4_1, QK4_NL, QK_K,
};
...
struct TinySpec {
    ...
    /// Q4_K / Q6_K / F32 mix used by [`tiny_llama_gguf`]. Q2_K / Q3_K / Q4_1 / Q5_K / IQ1_M /
    /// IQ1_S / IQ2_XXS / IQ2_XS / IQ2_S / IQ3_XXS / IQ3_S / IQ4_NL / IQ4_XS /
    /// BF16 are used by [`tiny_q2k_gguf`] / [`tiny_q3k_gguf`] / [`tiny_q41_gguf`] /
    /// [`tiny_q5k_gguf`] /
...
mod tests {
    ...
    fn decode_load_unsupported_ggml_type_error_includes_type_id() {
        // ggml Q5_0 is 6; Q4_1 (3) is now loaded. Remaining after Q4_1.
        const Q5_0: i32 = 6;
        ...
        assert!(
            err.contains(&Q5_0.to_string()),
            "error should include type id {Q5_0}: {err}"
        );
    }
