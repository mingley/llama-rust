...
use crate::quant::{
    ...
    gemv_iq4_xs_f32, gemv_q2_k_f32, gemv_q3_k_f32, gemv_q4_k_f32, gemv_q5_k_f32, gemv_q6_k_f32,
    ...
    pack_q2_k_block, pack_q3_k_block, pack_q4_k_block, pack_q5_k_block, pack_q6_k_block,
    q2_k_row_bytes, q3_k_row_bytes, q4_k_row_bytes, q5_k_row_bytes, q6_k_row_bytes, QuantError,
    QK4_NL, QK_K,
};
...
struct TinySpec {
    ...
    /// Q4_K / Q6_K / F32 mix used by [`tiny_llama_gguf`]. Q2_K / Q3_K / Q5_K / IQ1_M /
    /// IQ1_S / IQ2_XXS / IQ2_XS / IQ2_S / IQ3_XXS / IQ3_S / IQ4_NL / IQ4_XS /
    /// BF16 are used by [`tiny_q2k_gguf`] / [`tiny_q3k_gguf`] / [`tiny_q5k_gguf`] /
...
mod tests {
    ...
    fn decode_load_unsupported_ggml_type_error_includes_type_id() {
        // ggml Q4_1 is 3; Q4_K (12) is already loaded. Remaining after Q3_K.
        const Q4_1: i32 = 3;
        ...
        assert!(
            err.contains(&Q4_1.to_string()),
            "error should include type id {Q4_1}: {err}"
        );
    }
