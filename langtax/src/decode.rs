...
use crate::quant::{
    ...
    gemv_iq4_nl_f32, gemv_iq4_xs_f32, gemv_q4_k_f32, gemv_q5_k_f32, gemv_q6_k_f32, iq1_s_row_bytes,
    iq2_s_row_bytes, iq2_xs_row_bytes, iq2_xxs_row_bytes, iq3_s_row_bytes, iq3_xxs_row_bytes,
    iq4_nl_row_bytes, iq4_xs_row_bytes, pack_f16, pack_f32, pack_iq1_s_block, pack_iq2_s_block,
...
struct TinySpec {
    ...
    /// Q4_K / Q6_K / F32 mix used by [`tiny_llama_gguf`]. Q5_K / IQ1_S / IQ2_XXS /
    /// IQ2_XS / IQ2_S / IQ3_XXS / IQ3_S / IQ4_NL / IQ4_XS are used by
    /// [`tiny_q5k_gguf`] / [`tiny_iq1s_gguf`] / [`tiny_iq2xxs_gguf`] /
...
mod tests {
    ...
    fn decode_load_unsupported_ggml_type_error_includes_type_id() {
        ...
        assert!(
            err.contains(&IQ1_M.to_string()),
            "error should include type id {IQ1_M}: {err}"
        );
    }
