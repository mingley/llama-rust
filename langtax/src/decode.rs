...
use crate::quant::{
    ...
    gemm_q4_k_f32, gemm_q5_k_f32, gemm_q6_k_f32, gemv_f16, gemv_f32, gemv_iq4_xs_f32,
    gemv_q4_k_f32, gemv_q5_k_f32, gemv_q6_k_f32, iq4_xs_row_bytes, pack_f16, pack_f32,
    pack_iq4_xs_block, pack_q4_k_block, pack_q5_k_block, pack_q6_k_block, q4_k_row_bytes,
    q5_k_row_bytes, q6_k_row_bytes, QuantError, QK_K,
};
...
struct TinySpec {
    ...
    /// Q4_K / Q6_K / F32 mix used by [`tiny_llama_gguf`]. Q5_K / IQ4_XS are used
    /// by [`tiny_q5k_gguf`] / [`tiny_iq4xs_gguf`].
