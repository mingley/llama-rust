...
//! graph update/clone/set-params/build/build-deps/host/piecewise/capture-deps/enable/mem/memset, timing events, `event_blocking_sync`, `seq_streams`, `kv_sim`, `decode_priority`,
...
//! no API wait; not with `--memcpy-during`). Decode
