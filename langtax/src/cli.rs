...
fn check_engine_sim_opts(n: &EngineSimNeed) -> Result<(), String> {
    ...
    if (n.gpu.shareable || n.gpu.share_ptr)
        && (n.gpu.sync_alloc || n.gpu.ipc || n.gpu.mapped || n.gpu.managed || n.gpu.vmm)
    {
