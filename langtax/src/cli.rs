...
usage: gguf_gemv <command> [args]
  ...
  write|gemv|write-q4k|gemv-q4k|write-tiny|write-tiny-qwen2|write-tiny-qwen3|write-tiny-gemma|write-tiny-gemma2|write-tiny-gemma3|write-tiny-gemma3n|write-tiny-gemma4|write-tiny-gemma4-moe|write-tiny-gemma4-ple|write-tiny-gemma4-moe-ple|write-tiny-gemma4-moe-fused|write-tiny-gemma4-moe-fused-ple|write-tiny-gemma4-shared-kv|write-tiny-gemma4-mixed-hd|write-tiny-gemma4-swa-base|write-tiny-gemma4-no-wv|write-tiny-gemma4-out-scale|write-tiny-gemma4-rope-freqs|write-tiny-gemma4-moe-down-s|write-tiny-gemma4-moe-gate-up-s|write-tiny-llama-ffn-down-s|write-tiny-llama-ffn-gate-s|write-tiny-llama-ffn-up-s|write-tiny-nvfp4-output-s|write-tiny-bloom-attn-qkv-s|write-tiny-qwen2moe-ffn-down-shexp-s|write-tiny-qwen2moe-ffn-gate-shexp-s|write-tiny-qwen2moe-ffn-up-shexp-s|write-tiny-llama-attn-q-s|write-tiny-llama-attn-out-s|write-tiny-llama-attn-k-s|write-tiny-llama-attn-v-s|write-tiny-llama4|write-tiny-llama-moe|write-tiny-qwen2moe|write-tiny-qwen3moe|write-tiny-qwen3moe-2layer|write-tiny-qwen2vl|write-tiny-qwen3vl|write-tiny-qwen3next|write-tiny-qwen35|write-tiny-phi2|write-tiny-bloom <path>
";
